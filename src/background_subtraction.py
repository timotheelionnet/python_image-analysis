...
# 4. Calculate the average intensity on each channel for that background object

import numpy as np
from scipy.ndimage import label, find_objects

def get_largest_background(mask, image):
    """
    ...
    if num_features == 0:
        return {'area': 0, 'average_intensities': [0] * image.shape[0]}
